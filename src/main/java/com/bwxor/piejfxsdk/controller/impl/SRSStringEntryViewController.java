...
public class SRSStringEntryViewController extends MovableViewController {
    ...
    public void populate(String existing) {
        if (existing != null) valueField.setText(existing);
    }

    @FXML
    public void onSaveButtonClick() {
        if (onSave != null) {
            onSave.accept(valueField.getText().trim());
        }
        close();
    }
